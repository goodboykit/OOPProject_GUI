...
public class About extends JPanel {
	...
	public About() {
		...
		imgFeature1.setIcon(new ImageIcon("D:\\LAZARO\\QueueManagementSystem\\imgs\\feature_1.png"));
		
		JLabel imgFeature2 = new JLabel("");
		imgFeature2.setBounds(488, 276, 292, 285);
		contentPanel.add(imgFeature2);
		imgFeature2.setIcon(new ImageIcon("D:\\LAZARO\\QueueManagementSystem\\imgs\\feature_2.png"));
		
		JLabel imgFeature3 = new JLabel("");
		imgFeature3.setBounds(810, 276, 292, 285);
		contentPanel.add(imgFeature3);
		imgFeature3.setIcon(new ImageIcon("D:\\LAZARO\\QueueManagementSystem\\imgs\\feature_3.png"));
	}
